...
?>
        ...
        <form action="register.php" method="POST" name="Login_Form" class="form-signin">
            ...
            <div class="form__field">
                <label for="login__password"><svg class="icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#lock"></use></svg><span class="hidden">Password</span></label>
                <input id="login__password" type="password" name="senha_confirmada" class="form__input" placeholder="Confirmar Senha"  required="" tabindex="3">
            </div>
                    <br>
            <div class="form__field">
                ...
                <input id="nome_mae" type="text" name="nomeMae" class="form__input" placeholder="Nome Mãe"  required="" tabindex="4">
            </div>

            <div class="form__field">
                <input  class="btn btn-lg btn-primary btn-block" name="submit" type="submit" tabindex="5" value="Cadastrar">
            </div>
        </form>
