               ...
               <div class="user-dashboard">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12 gutter">
                            <form action="../../function/empresa/cadastroEmpresa.php" method="POST">
                                <div class="col-sm-12">
                                    <label for="nome">Nome: </label>
                                    <input type="text" class="form-control" id="_nome" placeholder="Nome Empresa" name="nome"><br>
                                    ...
                                    <input type="email" class="form-control" id="_email" placeholder="exemplo@exemplo.com" name="email"><br>
